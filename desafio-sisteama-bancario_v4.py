...
def log_transacao(func):
    def envelope(*args, **kwargs):
        ...
        with open(ROOT_PATH / "desafio_logs" / 'log.txt','a', encoding="utf8") as arquivo:
            arquivo.write(
                f"[{data_hora}] Função '{func.__name__}' executada com argumentos {args} e {kwargs}. Resultado: {resultado}\n"        
            )
